...
from kvant_agents.configuration import load_env
from kvant_agents.marketing_strategy.crew import MarketingPostsCrew
...
async def run():
    ...
    @server.agent(
        ...
        **Metadata(
            ...
            license="Apache 2.0",
            languages=["Python"],
            githubUrl="https://github.com/chandra-potula/beeai/tree/poc-beeai-server-v0.0.7/agents/community/kvant-agents/src/kvant_agents/marketing_strategy",
